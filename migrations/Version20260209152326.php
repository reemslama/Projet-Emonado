 ...
 */
final class Version20260209152326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE journal (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, humeur VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_C1A7E74DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
