 ...
 */
final class Version20260510131541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analyse_emotionnelle (id INT AUTO_INCREMENT NOT NULL, journal_id INT NOT NULL, emotion_principale VARCHAR(255) DEFAULT NULL, niveau_stress VARCHAR(255) DEFAULT NULL, score_bien_etre INT DEFAULT NULL, resume_ia LONGTEXT DEFAULT NULL, date_analyse DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_DE8A3A10478E8802 (journal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE audit_log (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, action VARCHAR(50) DEFAULT NULL, entity_type VARCHAR(100) DEFAULT NULL, entity_id VARCHAR(100) DEFAULT NULL, details LONGTEXT DEFAULT NULL, ip VARCHAR(45) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_F6E1C0F5A76ED395 (user_id), INDEX IDX_F6E1C0F5B03A8386 (created_by_id), INDEX IDX_F6E1C0F5896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, dossier_id INT NOT NULL, psychologue_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, date DATE DEFAULT NULL, compte_rendu LONGTEXT DEFAULT NULL, humeur_patient VARCHAR(100) DEFAULT NULL, sujet_aborde LONGTEXT DEFAULT NULL, observations LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_964685A6611C0C56 (dossier_id), INDEX IDX_964685A6465459D3 (psychologue_id), INDEX IDX_964685A6B03A8386 (created_by_id), INDEX IDX_964685A6896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_document (id INT AUTO_INCREMENT NOT NULL, consultation_id INT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, type_fichier VARCHAR(50) DEFAULT NULL, path_or_url VARCHAR(500) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_96280AD362FF6CDF (consultation_id), INDEX IDX_96280AD3B03A8386 (created_by_id), INDEX IDX_96280AD3896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_payment (id INT AUTO_INCREMENT NOT NULL, rendez_vous_id INT NOT NULL, consultation_id INT DEFAULT NULL, patient_id INT NOT NULL, psychologue_id INT NOT NULL, stripe_session_id VARCHAR(255) DEFAULT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, checkout_url LONGTEXT DEFAULT NULL, amount_cents INT NOT NULL, currency VARCHAR(10) NOT NULL, status VARCHAR(30) NOT NULL, paid_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_282B75EF91EF7EAA (rendez_vous_id), INDEX IDX_282B75EF62FF6CDF (consultation_id), INDEX IDX_282B75EF6B899279 (patient_id), INDEX IDX_282B75EF465459D3 (psychologue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_questionnaire (id INT AUTO_INCREMENT NOT NULL, payment_id INT NOT NULL, rendez_vous_id INT NOT NULL, patient_id INT NOT NULL, psychologue_id INT NOT NULL, chief_complaint LONGTEXT NOT NULL, symptom_summary LONGTEXT NOT NULL, voice_transcript LONGTEXT DEFAULT NULL, stress_level INT NOT NULL, anxiety_level INT NOT NULL, mood_level INT NOT NULL, sleep_quality INT NOT NULL, energy_level INT NOT NULL, support_level INT NOT NULL, urgency_level INT NOT NULL, self_harm_risk VARCHAR(30) NOT NULL, additional_context LONGTEXT DEFAULT NULL, risk_score INT NOT NULL, predicted_state VARCHAR(255) NOT NULL, submitted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4D9A6E0E4C3A3BB (payment_id), INDEX IDX_4D9A6E0E91EF7EAA (rendez_vous_id), INDEX IDX_4D9A6E0E6B899279 (patient_id), INDEX IDX_4D9A6E0E465459D3 (psychologue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE disponibilite (id INT AUTO_INCREMENT NOT NULL, psychologue_id INT DEFAULT NULL, date DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, est_libre INT NOT NULL, INDEX IDX_2CBACE2F465459D3 (psychologue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dossier_medical (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, historique_medical LONGTEXT DEFAULT NULL, notes_psychologiques LONGTEXT DEFAULT NULL, diagnostic LONGTEXT DEFAULT NULL, traitement_fond LONGTEXT DEFAULT NULL, objectifs_long_terme LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3581EE626B899279 (patient_id), INDEX IDX_3581EE62B03A8386 (created_by_id), INDEX IDX_3581EE62896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, dispo_id INT DEFAULT NULL, user_id INT NOT NULL, age INT DEFAULT NULL, adresse LONGTEXT DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, statut VARCHAR(32) DEFAULT NULL, notes_patient LONGTEXT DEFAULT NULL, notes_psychologue LONGTEXT DEFAULT NULL, INDEX IDX_65E8AA0AC54C8C93 (type_id), INDEX IDX_65E8AA0AA18C1CC9 (dispo_id), INDEX IDX_65E8AA0AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE test_psy_participation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date_test DATETIME NOT NULL, rapport_ia LONGTEXT DEFAULT NULL, score_anxiete INT DEFAULT 0 NOT NULL, score_tristesse INT DEFAULT 0 NOT NULL, score_colere INT DEFAULT 0 NOT NULL, score_joie INT DEFAULT 0 NOT NULL, INDEX IDX_55B2DB62A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_psy_reponse (id INT AUTO_INCREMENT NOT NULL, scene_id INT NOT NULL, label VARCHAR(255) DEFAULT NULL, label_en VARCHAR(255) DEFAULT NULL, label_ar VARCHAR(255) DEFAULT NULL, emoji VARCHAR(255) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, etat_desc VARCHAR(255) DEFAULT NULL, etat_desc_en VARCHAR(255) DEFAULT NULL, etat_desc_ar VARCHAR(255) DEFAULT NULL, couleur VARCHAR(50) DEFAULT NULL, poids_anxiete INT DEFAULT 0 NOT NULL, poids_tristesse INT DEFAULT 0 NOT NULL, poids_colere INT DEFAULT 0 NOT NULL, poids_joie INT DEFAULT 0 NOT NULL, INDEX IDX_C579F367166053B4 (scene_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_psy_scene (id INT AUTO_INCREMENT NOT NULL, numero INT NOT NULL, type VARCHAR(50) NOT NULL, titre VARCHAR(255) DEFAULT NULL, titre_en VARCHAR(255) DEFAULT NULL, titre_ar VARCHAR(255) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, sound_path VARCHAR(255) DEFAULT NULL, description_psy LONGTEXT DEFAULT NULL, description_en LONGTEXT DEFAULT NULL, description_ar LONGTEXT DEFAULT NULL, actif TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_rendez_vous (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE audit_log ADD CONSTRAINT FK_F6E1C0F5B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A6B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE consultation_document ADD CONSTRAINT FK_96280AD3B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE consultation_payment ADD CONSTRAINT FK_282B75EF91EF7EAA FOREIGN KEY (rendez_vous_id) REFERENCES rendez_vous (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_payment ADD CONSTRAINT FK_282B75EF62FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_payment ADD CONSTRAINT FK_282B75EF6B899279 FOREIGN KEY (patient_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_payment ADD CONSTRAINT FK_282B75EF465459D3 FOREIGN KEY (psychologue_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_questionnaire ADD CONSTRAINT FK_4D9A6E0E4C3A3BB FOREIGN KEY (payment_id) REFERENCES consultation_payment (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_questionnaire ADD CONSTRAINT FK_4D9A6E0E91EF7EAA FOREIGN KEY (rendez_vous_id) REFERENCES rendez_vous (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_questionnaire ADD CONSTRAINT FK_4D9A6E0E6B899279 FOREIGN KEY (patient_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_questionnaire ADD CONSTRAINT FK_4D9A6E0E465459D3 FOREIGN KEY (psychologue_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE disponibilite ADD CONSTRAINT FK_2CBACE2F465459D3 FOREIGN KEY (psychologue_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE prescription ADD CONSTRAINT FK_1FBFB8D9B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0AA18C1CC9 FOREIGN KEY (dispo_id) REFERENCES disponibilite (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE test_psy_participation ADD CONSTRAINT FK_55B2DB62A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE test_psy_reponse ADD CONSTRAINT FK_C579F367166053B4 FOREIGN KEY (scene_id) REFERENCES test_psy_scene (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation_payment DROP FOREIGN KEY FK_282B75EF91EF7EAA');
        $this->addSql('ALTER TABLE consultation_payment DROP FOREIGN KEY FK_282B75EF62FF6CDF');
        $this->addSql('ALTER TABLE consultation_payment DROP FOREIGN KEY FK_282B75EF6B899279');
        $this->addSql('ALTER TABLE consultation_payment DROP FOREIGN KEY FK_282B75EF465459D3');
        $this->addSql('ALTER TABLE consultation_questionnaire DROP FOREIGN KEY FK_4D9A6E0E4C3A3BB');
        $this->addSql('ALTER TABLE consultation_questionnaire DROP FOREIGN KEY FK_4D9A6E0E91EF7EAA');
        $this->addSql('ALTER TABLE consultation_questionnaire DROP FOREIGN KEY FK_4D9A6E0E6B899279');
        $this->addSql('ALTER TABLE consultation_questionnaire DROP FOREIGN KEY FK_4D9A6E0E465459D3');
        $this->addSql('ALTER TABLE disponibilite DROP FOREIGN KEY FK_2CBACE2F465459D3');
        ...
        $this->addSql('ALTER TABLE test_psy_participation DROP FOREIGN KEY FK_55B2DB62A76ED395');
        $this->addSql('ALTER TABLE test_psy_reponse DROP FOREIGN KEY FK_C579F367166053B4');
        ...
        $this->addSql('DROP TABLE consultation_payment');
        $this->addSql('DROP TABLE consultation_questionnaire');
        ...
        $this->addSql('DROP TABLE test_psy_participation');
        $this->addSql('DROP TABLE test_psy_reponse');
        $this->addSql('DROP TABLE test_psy_scene');
